...
INSERT INTO [dbo].[Users] ([Id]) VALUES (4)
INSERT INTO [dbo].[Users] ([Id]) VALUES (5)
SET IDENTITY_INSERT [dbo].[Users] OFF

INSERT INTO [dbo].[Employee] ([EmployeeId], [HoursApprovalLimit], [CostApprovalLimit], [DistrictId]) VALUES (1, CAST(50 AS Decimal(18, 0)), CAST(2000 AS Decimal(18, 0)), 4)
INSERT INTO [dbo].[Employee] ([EmployeeId], [HoursApprovalLimit], [CostApprovalLimit], [DistrictId]) VALUES (2, CAST(100 AS Decimal(18, 0)), CAST(5200 AS Decimal(18, 0)), 4)
INSERT INTO [dbo].[Employee] ([EmployeeId], [HoursApprovalLimit], [CostApprovalLimit], [DistrictId]) VALUES (3, CAST(10 AS Decimal(18, 0)), CAST(10000 AS Decimal(18, 0)), 5)

SET IDENTITY_INSERT [dbo].[InterventionType] ON
INSERT INTO [dbo].[InterventionType] ([InterventionTypeId], [Name], [Hours], [Cost]) VALUES (2, N'Supply and Install Portable Toilet', CAST(2 AS Decimal(18, 0)), CAST(600 AS Decimal(18, 0)))
INSERT INTO [dbo].[InterventionType] ([InterventionTypeId], [Name], [Hours], [Cost]) VALUES (3, N'Hepatitis Avoidance Training', CAST(3 AS Decimal(18, 0)), CAST(0 AS Decimal(18, 0)))
INSERT INTO [dbo].[InterventionType] ([InterventionTypeId], [Name], [Hours], [Cost]) VALUES (4, N'Supply and Install Storm-proof Home Kit', CAST(8 AS Decimal(18, 0)), CAST(500 AS Decimal(18, 0)))
INSERT INTO [dbo].[InterventionType] ([InterventionTypeId], [Name], [Hours], [Cost]) VALUES (5, N'Supply Mosquito Net', CAST(0 AS Decimal(18, 0)), CAST(25 AS Decimal(18, 0)))
INSERT INTO [dbo].[InterventionType] ([InterventionTypeId], [Name], [Hours], [Cost]) VALUES (6, N'Install Water Pump', CAST(80 AS Decimal(18, 0)), CAST(1200 AS Decimal(18, 0)))
INSERT INTO [dbo].[InterventionType] ([InterventionTypeId], [Name], [Hours], [Cost]) VALUES (7, N'Supply High-Volume Water Filter and Train Users', CAST(1 AS Decimal(18, 0)), CAST(2000 AS Decimal(18, 0)))
INSERT INTO [dbo].[InterventionType] ([InterventionTypeId], [Name], [Hours], [Cost]) VALUES (8, N'Prepare Sewerage Trench', CAST(50 AS Decimal(18, 0)), CAST(0 AS Decimal(18, 0)))
