...
namespace au.edu.uts.ASDF.ENETCare.InterventionManagement.Data.DataSets {
    ...
    public partial class ClientDataSet : global::System.Data.DataSet {
        ...
        public partial class ClientDataTable : global::System.Data.TypedTableBase<ClientRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public ClientRow AddClientRow(int ClientId, string Name, string Location, int DistrictId) {
...
namespace au.edu.uts.ASDF.ENETCare.InterventionManagement.Data.DataSets.ClientDataSetTableAdapters {
    ...
    public partial class ClientTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Client] ([ClientId], [Name], [Location], [DistrictId]) VALUES " +
                "(@ClientId, @Name, @Location, @DistrictId);\r\nSELECT ClientId, Name, Location, Di" +
                "strictId FROM Client WHERE (ClientId = @ClientId)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Client] SET [ClientId] = @ClientId, [Name] = @Name, [Location] = @Location, [DistrictId] = @DistrictId WHERE (([ClientId] = @Original_ClientId) AND ([Name] = @Original_Name) AND ([Location] = @Original_Location) AND ([DistrictId] = @Original_DistrictId));
SELECT ClientId, Name, Location, DistrictId FROM Client WHERE (ClientId = @ClientId)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1].CommandText = "SELECT ClientId, Name, Location, DistrictId FROM dbo.Client WHERE ClientId = @Cli" +
                "entId";
        ...
        public virtual int Fill(ClientDataSet.ClientDataTable dataTable) {
        ...
        public virtual ClientDataSet.ClientDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            ClientDataSet.ClientDataTable dataTable = new ClientDataSet.ClientDataTable();
        ...
        public virtual int FillByClientId(ClientDataSet.ClientDataTable dataTable, int ClientId) {
        ...
        public virtual ClientDataSet.ClientDataTable GetDataByClientId(int ClientId) {
            this.Adapter.SelectCommand = this.CommandCollection[1];
            this.Adapter.SelectCommand.Parameters[0].Value = ((int)(ClientId));
            ClientDataSet.ClientDataTable dataTable = new ClientDataSet.ClientDataTable();
            this.Adapter.Fill(dataTable);
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(ClientDataSet.ClientDataTable dataTable) {
        ...
        public virtual int Insert(int ClientId, string Name, string Location, int DistrictId) {
        ...
        public virtual int Update(int ClientId, string Name, string Location, int DistrictId, int Original_ClientId, string Original_Name, string Original_Location, int Original_DistrictId) {
        ...
        public virtual int Update(string Name, string Location, int DistrictId, int Original_ClientId, string Original_Name, string Original_Location, int Original_DistrictId) {
            return this.Update(Original_ClientId, Name, Location, DistrictId, Original_ClientId, Original_Name, Original_Location, Original_DistrictId);
        }
    }
