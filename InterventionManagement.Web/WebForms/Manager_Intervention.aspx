        ...
        <div align="center">
            ...
            <table border="0">
                <tr>
                    ...
                    <td>
                        <asp:Label ID="lbl_InterventionType" runat="server" Text="Label" /></td>
                </tr>
                <tr>
                    <td align="right"><b>Client:</b></td>
                    <td>
                        <asp:Label ID="lbl_ClientName" runat="server" Text="Label" /></td>
                </tr>
                <tr>
                    <td align="right"><b>Labour:</b></td>
                    <td>
                        <asp:Label ID="lbl_Labour" runat="server" Text="Label" /></td>
                </tr>
                <tr>
                    <td align="right"><b>Cost:</b></td>
                    <td>
                        <asp:Label ID="lbl_Cost" runat="server" Text="Label" /></td>
                </tr>
                <tr>
                    <td align="right"><b>Engineer:</b></td>
                    <td>
                        <asp:Label ID="lbl_EngineerName" runat="server" Text="Label" /></td>
                </tr>
                <tr>
                    <td align="right"><b>Proposed Date:</b></td>
                    <td>
                        <asp:Label ID="lbl_Date" runat="server" Text="Label" /></td>
                </tr>
            </table>
        </div>
