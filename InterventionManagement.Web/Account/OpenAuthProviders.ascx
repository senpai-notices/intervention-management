<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="OpenAuthProviders.ascx.cs" Inherits="au.edu.uts.ASDF.ENETCare.InterventionManagement.Web.Account.OpenAuthProviders" %>
